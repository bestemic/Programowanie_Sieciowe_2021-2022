...
public class WebScrapper {
    ...
    public static boolean parsePage(Connection.Response response) throws IOException {
        ...
        final Pattern currencyNamePattern = Pattern.compile("^[A-Z][a-z]+( [A-Z][a-z]+)*$");
        final Pattern exchangeRatePattern = Pattern.compile("^\\d+(\\.\\d)\\d*$");
